...
public class UserAuthServiceImpl extends ServiceImpl<UserAuthDao, UserAuth> implements UserAuthService {
    ...
    @Override
    public UserInfoDTO githubLogin(GithubLoginVO githubLoginVO) {
        return socialLoginStrategyContext.executeLoginStrategy(JSON.toJSONString(githubLoginVO), LoginTypeEnum.GITHUB);
    }
