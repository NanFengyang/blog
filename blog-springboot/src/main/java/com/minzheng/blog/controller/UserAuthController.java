...
public class UserAuthController {
    ...
    public Result<UserInfoDTO> githubLogin(@Valid @RequestBody GithubLoginVO githubLoginVO) {
        System.out.println(githubLoginVO.toString());
        return Result.ok(userAuthService.githubLogin(githubLoginVO));
    }
